...
@Component({
  ...
  standalone:true,
  imports: [CommonModule, FormsModule, HeaderComponent,MatInputModule,
    MatButtonModule,
    MatListModule,
    MatCheckboxModule,
    MatIconModule,
...
export class TodoListComponent implements OnInit {
  ...
  loadTask():void {
    ...
    if (savedTasks){ this.tasks = JSON.parse(savedTasks);
      ...
      this.tasks = [{ task: 'Learn Angular', completed: true, dueDate: new Date('2025-03-28')},
        {task: 'Build a to-do list', completed: false, dueDate: new Date('2025-03-31')},
      ];
    }
  }
...
//dark mode
toggleTheme(): void { // Add this method
